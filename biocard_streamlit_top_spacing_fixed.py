...
<style>
    ...
    /* Keep the game below Streamlit's floating toolbar.
       The safe-area value also helps when the game is embedded on a website. */
    .block-container,
    ...
    /* Prevent the first visual element from touching or slipping under the header. */
